...
import edu.ecnu.dase.util.FileOperation;
import edu.ecnu.dase.util.KMeans;
...
public class DocCluster {
	...
	public void docCluster(String filePath, int[] resulttemp) {
		...
		PrintWriter pw = null;
		try {
			pw = new PrintWriter(new FileOutputStream(new File("models/casestudy-china/predictDoc.txt"), true), true);
